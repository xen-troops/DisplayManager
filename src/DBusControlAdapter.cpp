...
DBusControlAdapter::DBusControlAdapter(
	DBusControlAdaptee* adaptee, string path) : Object(path)
{
...
{
	return shared_ptr<DBusControlAdapter>(new DBusControlAdapter(adaptee, path));
}
